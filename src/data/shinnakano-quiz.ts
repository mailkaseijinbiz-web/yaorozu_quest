// 新中野・クイズ巡礼データ
// -----------------------------------------------------------------------------
// ⚠️ 保留中の資産（2026-06 時点で UI からは未参照）。
//   旧 QuestTab.tsx 削除に伴い唯一の利用元が無くなったが、GPS解錠クイズ巡礼は
//   固有・再作成困難な機能のため意図的に温存している。クイズ巡礼を本実装する際は
//   ShinnakanoQuizSection 等のライブコンポーネントから本モジュールを import すること。
// -----------------------------------------------------------------------------
